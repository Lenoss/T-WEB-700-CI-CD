    ...
    <div class="div-nav">
      ...
      >
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            <span class="pr-1">Cryptos:</span>
            <span class="navbar-data-content pe-2 ps-1">10000</span>
          </li>
          <li class="nav-item">
            <span class="px-1">Exchanges:</span>
            <span class="navbar-data-content pe-2 ps-1">10000</span>
          </li>
          <li class="nav-item">
            <span class="px-1">Market Cap:</span>
            <span class="navbar-data-content pe-2 ps-1">10000</span>
          </li>
          <li class="nav-item">
            <span class="px-1">24h Vol:</span>
            <span class="navbar-data-content pe-2 ps-1">10000</span>
          </li>
          <li class="nav-item">
            <span class="px-1">Dominance:</span>
            <span class="navbar-data-content pe-2 ps-1">10000</span>
          </li>
          <li class="nav-item">
            <span class="px-1">ETH Gas:</span>
            <span class="navbar-data-content pe-2 ps-1">10000</span>
          </li>
        </ul>
    ...
    <div class="div-nav shadow-sm">
      ...
      >
        ...
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            <router-link class="nav-link fw-bold" to="/"
              >Cryptomonnaies</router-link
            >
          </li>
          <li class="nav-item">
            <router-link class="nav-link fw-bold" to="/articles"
        ...
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item">
            <router-link class="nav-link fw-bold" to="/logout"
